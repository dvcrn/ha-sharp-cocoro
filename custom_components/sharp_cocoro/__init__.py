...
class SharpCocoroData:
    ...
    async def async_ensure_authenticated(self) -> bool:
        ...
        try:
            ...
            if self.last_login_time and (datetime.now() - self.last_login_time) > TOKEN_REFRESH_INTERVAL:
        ...
        try:
            ...
            if "401" in str(e) or "unauthorized" in str(e).lower() or "authentication" in str(e).lower():
                ...
                try:
                    ...
                    _LOGGER.error("Failed to refresh data after re-authentication: %s", retry_error)
            else:
